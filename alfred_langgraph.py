...
class EmailState(TypedDict):
    ...
    email_category: NotRequired[Optional[str]]

    # Reason why the email was marked as spam
    spam_reason: NotRequired[Optional[str]]

    # Analysis and decisions
    is_spam: NotRequired[Optional[bool]]

    # Response generation
    email_draft: NotRequired[Optional[str]]
...
# Create the graph
email_graph = StateGraph(EmailState)  # type: ignore[type-var]
